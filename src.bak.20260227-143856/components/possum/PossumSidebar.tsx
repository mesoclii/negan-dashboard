...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    title: "Economy",
    items: [
      { label: "Economy Overview", href: "/dashboard/economy" },
      { label: "Transactions", href: "/dashboard/economy/transactions" },
      { label: "Store", href: "/dashboard/economy/store" },
    ],
  },
  {
    title: "Games",
    items: [
      { label: "Games Overview", href: "/dashboard/games" },
      { label: "Rare Engine", href: "/dashboard/games/rare" },
      { label: "Contracts", href: "/dashboard/games/contracts" },
      { label: "Crews", href: "/dashboard/games/crews" },
      { label: "Events", href: "/dashboard/games/events" },
      { label: "Pokemon", href: "/dashboard/games/pokemon" },
      { label: "Cat Engine", href: "/dashboard/games/cat" },
    ],
  },
  {
    title: "GTA Ops",
    items: [
      { label: "Heist Ops", href: "/dashboard/heist" },
      { label: "Sessions", href: "/dashboard/heist/sessions" },
      { label: "Limits", href: "/dashboard/heist/limits" },
      { label: "Force Close", href: "/dashboard/heist/force-close" },
    ],
  },
  {
    title: "AI",
    items: [
      ...
      { label: "Persona", href: "/dashboard/ai/persona" },
      { label: "Tone", href: "/dashboard/ai/tone" },
    ],
  },
];
    ...
    >
      ...
      <div
        style={{
          ...
          right: 18,
          bottom: 14,
          borderTop: `1px solid ${possum.divider}`,
          paddingTop: 12,
          color: possum.soft,
