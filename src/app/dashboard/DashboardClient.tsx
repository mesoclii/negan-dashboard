...
const CARDS: Card[] = [
  ...
  { href: "/dashboard/wow", title: "WoW Groups", description: "World of Warcraft 5-man, 10-man, and 25-man signup lanes with MOTD control.", toggle: engineController("wowGuild", ["enabled"]) },
